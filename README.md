...
This project was used to get familiar with PHP/Silex/Twig/PHPUnit and will take user inputs and replace one with the other.
...
* `git clone https://github.com/jaredbeckler/find-and-replace-php` this repository
